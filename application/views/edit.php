...
<body>
    ...
    <div class="paper  center">
        ...
        <br>
        <center>
            <h1><b>Update Data Pembayaran Pajak</b></h1>
        </center>
        <br>
        <?php foreach ($datapajak as $rows) { ?>
            <form action="<?php echo base_url() . 'user_controller/update'; ?>" method="post" name="formD" id="formD">
                <table style="margin:20px auto;">
                    <tr>
                        ...
                        <td><input type="text" name="no_urut" readonly value="<?= $rows->no_urut ?>"></td>
                    </tr>
                    <tr>
                        <td>
                            <h2>Jenis Motor</h2>
                        ...
                        <td><input type="text" name="jenis_motor" <?= $rows->jenis_motor ?>></td>
                    </tr>
                    <tr>
                        <td>
                            <h2>Biaya Pajak</h2>
                        ...
                        <td><input type="text" name="biaya_pajak" onkeyup="OnChange(this.value)" onkeypress="return isNumberKey(event)" <?= $rows->biaya_pajak ?>></td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td><input type="text" name="jumlah" onkeyup="OnChange(this.value)" onkeypress="return isNumberKey(event)" <?= $rows->jumlah ?>></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td></td>
